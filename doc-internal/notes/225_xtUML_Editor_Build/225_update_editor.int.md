...
5.1.1.6 to replace all content that has errors that are found in the following 
...
5.1.6 Editd ```bp.core/common/ModelRoot.java``` around line 136 to removed all 
...
5.1.14 Extract Mentor IP as specified in [5]  
	...
	* Remove ```bp.core/src/.../util/BridgePointDemoEncryptor.java```
	* Remove ```bp.core/src/.../util/BridgePointLicenseManager.java```
