...
6.4 Conclusion
The solutions described in 6.2 and 6.3 above are selected to provide a rapid
response to the customer. An issue is raised [5] to consider the more radical
change proposed in 6.1.

6.5 Results
                                  Before        After
Initial parse time                  25s          21s
Run time                           1890s         85s
Termination time                    75s          57s
Restart time (re-parse overhead)    77s         322s
Re-run time                        1850s         81s
...
losses. The Restart hit is due to the need to traverse the larger OAL instance
populations described above in 6.3.2.
