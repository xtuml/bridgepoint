...
ERROR: Found a danling reference.  An element with the following attributes could not be found:
...
Element Name: ModelIntegrityTests::Dangling Reference Tests::Package One::Component
...
scrolling to accommodate long reports.  This action is called from a new menu
item under the BridgePoint Utilities pop up menu.  
