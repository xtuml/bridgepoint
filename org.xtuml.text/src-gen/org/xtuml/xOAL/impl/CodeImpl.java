 ...
 * <ul>
 *   <li>{@link org.xtuml.xOAL.impl.CodeImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CodeImpl extends MinimalEObjectImpl.Container implements Code
{
  ...
  {
    return XOALPackage.Literals.CODE;
  }
  ...
  public EList<statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<statement>(statement.class, this, XOALPackage.CODE__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XOALPackage.CODE__STATEMENTS:
