...
public class AbstractXOALSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (XOALGrammarAccess) access;
	...
	/**
	 * Syntax:
	 *     ('from' 'instances' 'of' class_name 'where') | ('related' 'by' object_reference ('->' class_name '[' relation ']')+ 'where')
	 */
	...
	/**
	 * Syntax:
	 *     ('from' 'instances' 'of' class_name) | ('related' 'by' object_reference ('->' class_name '[' relation ']')+)
	 */
