package org.xtuml.bp.mc.template;
...
public class ModelCompilerSection extends OptionTemplateSection {
	...
	protected void updateModel(IProgressMonitor monitor) throws CoreException {
		...
		imageElement.setAttribute("icon", "../org.xtuml.bp.core/icons/xtuml-nature.gif"); //$NON-NLS-1$//$NON-NLS-2$
		imageElement.setAttribute("natureId", packageName + ".MCNature"); //$NON-NLS-1$ //$NON-NLS-2$
		imageElement.setAttribute("id", "org.xtuml.resoures.natureimage"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public String getUsedExtensionPoint() {
		return "org.xtuml.bp.core.model-compilers";
	}
	...
	public IPluginReference[] getDependencies(String schemaVersion) {
		...
		result.add(new PluginReference("org.xtuml.bp.core", null, 0)); //$NON-NLS-1$
		result
				.add(new PluginReference(
						"org.xtuml.bp.io.core", null, 0)); //$NON-NLS-1$
		result.add(new PluginReference("org.xtuml.bp.mc", null, 0)); //$NON-NLS-1$
