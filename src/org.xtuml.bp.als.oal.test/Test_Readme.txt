...
- On the Test tab, under 'Run a single test', specify 
  project 'org.xtuml.bp.als.oal.test' and test class 'OALTestSuite'
- Change workspace data to '${eclipse_home}/bp_tests/als.oal'
- Change VM Arguments to 
  '-DWORKSPACE_PATH=${workspace_loc}/org.xtuml.bp.als.oal.test/ -DLOGFILE_PATH=${eclipse_home}/bp_tests/als.oal/.metadata/.log'
