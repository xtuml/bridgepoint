//========================================================================
//
//File:      $RCSfile: TestEvent_Generics.java,v $
...
import org.xtuml.bp.core.CreateEventStatement_c;
import org.xtuml.bp.core.CreateEventToClass_c;
import org.xtuml.bp.core.CreateEventToCreator_c;
import org.xtuml.bp.core.CreateEventToExternalEntity_c;
import org.xtuml.bp.core.CreateEventToInstance_c;
import org.xtuml.bp.core.CreateSmEventStatement_c;
import org.xtuml.bp.core.EventDatumValue_c;
import org.xtuml.bp.core.EventParameterReference_c;
...
import org.xtuml.bp.core.GeneratePreexistingEvent_c;
...
public class TestEvent_Generics extends TestCase {
	...
	public void validateEvent(String act, int genType, int numStmts,
			...
			OalParserTest_Generics.validateBlkStmtVal(1, numStmts, numVal);
			...
			if (genType == 0) {
				Generate_c gen[] = Generate_c.GenerateInstances(OalParserTest_Generics.modelRoot);
				...
				GenerateToClass_c gen_a[] = GenerateToClass_c.GenerateToClassInstances(OalParserTest_Generics.modelRoot);
				assertEquals(1, gen_a.length);
				assertEquals(0, var.length);
				gsme = GenerateSmEventStatement_c.getOneE_GSMEOnR705(gen_a[0]);
			} else if (genType == 2) {
				GenerateToCreator_c gen_c[] = GenerateToCreator_c.GenerateToCreatorInstances(OalParserTest_Generics.modelRoot);
			...
			switch (genType) {
				...
				case 3 :{
					GenerateToExternalEntity_c gen_e[] = GenerateToExternalEntity_c.GenerateToExternalEntityInstances(OalParserTest_Generics.modelRoot);
				...
				case 4 : {
					...
					CreateEventToInstance_c cei[] = CreateEventToInstance_c.CreateEventToInstanceInstances(OalParserTest_Generics.modelRoot);
				...
				case 5 :{
					...
					assertEquals(1, var.length);
					CreateEventToClass_c cea[] = CreateEventToClass_c.CreateEventToClassInstances(OalParserTest_Generics.modelRoot);
				...
				case 6 :{
					...
					assertEquals(1, var.length);
					CreateEventToCreator_c cec[] = CreateEventToCreator_c.CreateEventToCreatorInstances(OalParserTest_Generics.modelRoot);
				...
				case 7 :{
					...
					CreateEventToExternalEntity_c cee[] =
						CreateEventToExternalEntity_c.CreateEventToExternalEntityInstances(OalParserTest_Generics.modelRoot);
		...
		public void testGeneratePreExistingFromVar() throws RecognitionException, TokenStreamException {
			...
			String x = OalParserTest_Generics.parseAction(act, OalParserTest_Generics.ACTIVITY_TYPE_FUNC, OalParserTest_Generics.TEST_VOID_NO_PARM); //$NON-NLS-1$
			assertEquals("", x); //$NON-NLS-1$
			OalParserTest_Generics.validateBlkStmtVal(1, 2, 1);
			Variable_c var[] = Variable_c.VariableInstances(OalParserTest_Generics.modelRoot);
			assertEquals(1, var.length);
			Value_c[] val = Value_c.ValueInstances(OalParserTest_Generics.modelRoot);
			ActualParameter_c parms[];
			GeneratePreexistingEvent_c gpe[] = GeneratePreexistingEvent_c.GeneratePreexistingEventInstances(OalParserTest_Generics.modelRoot);
		...
		private void generateEventToSelf(int activityType) throws RecognitionException, TokenStreamException {
			...
			String x = OalParserTest_Generics.parseAction(act, activityType, OalParserTest_Generics.STATE_ISM_NONE); //$NON-NLS-1$
			assertEquals("", x); //$NON-NLS-1$
		...
		private void createEventToSelf(int activityType) throws RecognitionException, TokenStreamException {
			...
			OalParserTest_Generics.clearActionData(activityType, OalParserTest_Generics.STATE_ISM_NONE);
		}
		...
		private void validateBadGenEvent(String act, String[] err_msg, int numStmts, int numVal)
			...
			OalParserTest_Generics.validateBlkStmtVal(1, numStmts, numVal);
			EventSpecificationStatement_c ess[] = EventSpecificationStatement_c.EventSpecificationStatementInstances(OalParserTest_Generics.modelRoot);
			assertEquals(0, ess.length);
			GenerateEventStatement_c ges[] = GenerateEventStatement_c.GenerateEventStatementInstances(OalParserTest_Generics.modelRoot);
			assertEquals(0, ges.length);
			GenerateSmEventStatement_c gsme[] = GenerateSmEventStatement_c.GenerateSmEventStatementInstances(OalParserTest_Generics.modelRoot);
		...
		public void validateEvtParam(int activityType, String act, int actNum, int numStmts, int numVal, int numVar, int numEDV, String[] names)
			throws RecognitionException, TokenStreamException {
			String x = OalParserTest_Generics.parseAction(act, activityType, actNum); //$NON-NLS-1$
			assertEquals("", x); //$NON-NLS-1$
			OalParserTest_Generics.validateBlkStmtVal(1, numStmts, numVal);
			Variable_c var[] = Variable_c.VariableInstances(OalParserTest_Generics.modelRoot);
			...
			EventDatumValue_c[] edv = EventDatumValue_c.EventDatumValueInstances(OalParserTest_Generics.modelRoot);
		...
		public void testRead1EvtData() throws RecognitionException, TokenStreamException {
			...
			validateEvtParam( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, OalParserTest_Generics.STATE_ISM_ONE, 1, 2, 1, 1, names);
			validateEvtParam( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, OalParserTest_Generics.STATE_ASM_ONE, 1, 2, 1, 1, names);
		...
		public void testRead1SDTEvtData() throws RecognitionException, TokenStreamException {
			...
			validateEvtParam( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, OalParserTest_Generics.STATE_ISM_SDTTest, 1, 3, 1, 1, names);
			validateEvtParam( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, OalParserTest_Generics.STATE_ASM_SDTTest, 1, 3, 1, 1, names);
		...
		public void testRead1SDTMultLvlEvtData() throws RecognitionException, TokenStreamException {
			...
			String names[] = { "SDT_e" };//$NON-NLS-1$
			validateEvtParam( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, OalParserTest_Generics.STATE_ISM_SDTMultLvlTest, 1, 4, 1, 1, names);
			validateEvtParam( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, OalParserTest_Generics.STATE_ASM_SDTMultLvlTest, 1, 4, 1, 1, names);
		...
		public void testRead2EvtData() throws RecognitionException, TokenStreamException {
			...
			validateEvtParam( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, OalParserTest_Generics.STATE_ASM_TWO, 2, 4, 2, 2, names);
		...
		public void testRead3EvtData() throws RecognitionException, TokenStreamException {
			...
			validateEvtParam( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, OalParserTest_Generics.STATE_ASM_THREE, 3, 6, 3, 3, names);
		...
		public void testReadNoSuchEvtData() throws RecognitionException, TokenStreamException {
			...
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ISM_ONE, 0, 2, 1, 1 );
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ASM_ONE, 0, 2, 1, 1 );
		...
		public void testWriteEvtData() throws RecognitionException, TokenStreamException {
			...
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ASM_ONE, 1, 2, 1, 0 );
		...
		public void testWriteEvtParms() throws RecognitionException, TokenStreamException {
			...
			String[] err_msg = { ":1:7-7: Event parameters are not assignable",
					...
					"line 1:13: expecting Semicolon, found 'null'"};//$NON-NLS-1$
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ISM_ONE, 0, 0, 0, 0 );
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ASM_ONE, 0, 0, 0, 0 );
		...
		public void testWriteEvtDataMultData() throws RecognitionException, TokenStreamException {
			...
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ASM_TWO, 1, 2, 1, 0 );
		...
		public void testWriteEvtParmsMultParms() throws RecognitionException, TokenStreamException {
			...
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ISM_TWO, 0, 0, 0, 0 );
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ASM_TWO, 0, 0, 0, 0 );
		...
		public void testWriteEvtDataWrongTypeMultData() throws RecognitionException, TokenStreamException {
			...
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ASM_THREE, 1, 2, 1, 0 );
		...
		public void testWriteEvtParmWrongTypeMultParm() throws RecognitionException, TokenStreamException {
			...
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ISM_THREE, 0, 0, 0, 0 );
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ASM_THREE, 0, 0, 0, 0 );
		...
		public void testReadEvtDataWrongType() throws RecognitionException, TokenStreamException {
			...
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ISM_ONE, 1, 3, 1, 0 );
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ASM_ONE, 1, 3, 1, 0 );
		...
		public void testReadEvtDataWrongTypeMultParms() throws RecognitionException, TokenStreamException {
			...
			String[] err_msg = { ":1:24-24: Variable ->x<- already exists as a different type",//$NON-NLS-1$
				"line 1:26: expecting Semicolon, found 'null'" };//$NON-NLS-1$
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ISM_THREE, 1, 3, 1, 0 );
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ASM_THREE, 1, 3, 1, 0 );
		...
		public void testReadNoSuchPolyEvtData() throws RecognitionException, TokenStreamException {
			...
			String[] err_msg = { ":1:14-14: The following incoming messages do not carry required parameter ->x<- poly_data",//$NON-NLS-1$
				"line 1:16: unexpected token: null",//$NON-NLS-1$
				"line 1:16: expecting Semicolon, found 'null'" };//$NON-NLS-1$
			validateEvtParamError( OalParserTest_Generics.ACTIVITY_TYPE_STATE, act, err_msg, OalParserTest_Generics.STATE_ISM_POLYTWO, 0, 2, 1, 1 );
