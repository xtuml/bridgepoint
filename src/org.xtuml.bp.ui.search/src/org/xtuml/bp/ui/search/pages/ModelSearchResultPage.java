...
import org.xtuml.bp.ui.search.providers.ModelSearchContentProvider;
import org.xtuml.bp.ui.search.providers.ModelSearchLabelProvider;
import org.xtuml.bp.ui.search.providers.ModelSearchTableContentProvider;
		...
		if (!description) {
			try {
				...
				return PlatformUI
						...
						.getActivePage()
						.openEditor(input,
								"org.xtuml.bp.ui.text.activity.ActivityEditor", activate);
			...
			try {
				...
				return PlatformUI
						...
						.getActivePage()
						.openEditor(input,
								"org.xtuml.bp.ui.text.description.DescriptionEditor", activate);
			} catch (CoreException e) {
