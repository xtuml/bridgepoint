...
public class ComponentParamTest_Generics extends BaseTest {
  ...
  public ComponentParamTest_Generics() {
  	super("com.mentor.nucleus.bp.als.oal.test", null);
  }
  ...
  private String parseAction(String stmts, int actNum) {
    ...
    parser.m_oal_context = new Oal_validate(ContainerUtil.getContainer(act));
