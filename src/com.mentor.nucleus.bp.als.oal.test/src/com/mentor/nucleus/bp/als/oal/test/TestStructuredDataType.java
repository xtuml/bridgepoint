//========================================================================
//
//File:      $RCSfile: TestStructuredDataType.java,v $
...
public class TestStructuredDataType extends TestCase {
    ...
    public void testAssignTypeMismatchBool2SDT() throws RecognitionException,
        ...
        UUID personId = BaseTest.getTypeID(OalParserTest.modelRoot, "Person");//$NON-NLS-1$
    ...
    public void testAssignTypeMismatchEnum2SDT() throws RecognitionException,
            TokenStreamException {
        UUID personId = BaseTest.getTypeID(OalParserTest.modelRoot, "Person");//$NON-NLS-1$
        UUID fruitId = BaseTest.getTypeID(OalParserTest.modelRoot, "fruit");//$NON-NLS-1$
    ...
    public void testAssignTypeMismatchString2SDT() throws RecognitionException,
            TokenStreamException {
        UUID personId = BaseTest.getTypeID(OalParserTest.modelRoot, "Person");//$NON-NLS-1$
        UUID stringId = BaseTest.getTypeID(OalParserTest.modelRoot, "string");//$NON-NLS-1$
    ...
    public void testAssignTypeMismatchString2UDT() throws RecognitionException,
            TokenStreamException {
        UUID personId = BaseTest.getTypeID(OalParserTest.modelRoot, "Person");//$NON-NLS-1$
        UUID udt_booleanId = BaseTest.getTypeID(OalParserTest.modelRoot, "udt_boolean");//$NON-NLS-1$
    ...
    public void testAssignTypeMismatchSDT2Bool() throws RecognitionException,
            TokenStreamException {
        UUID boolId = BaseTest.getTypeID(OalParserTest.modelRoot, "boolean");//$NON-NLS-1$
        UUID animalId = BaseTest.getTypeID(OalParserTest.modelRoot, "Animal");//$NON-NLS-1$
	...
	public void testAssignBool2SDTstring() throws RecognitionException, TokenStreamException {
		...
		OalParserTest.validateBlkStmtVal( 1, 1, 3 );
    ...
    public void testAssignUDT2SDTstring() throws RecognitionException, TokenStreamException {
        ...
        OalParserTest.validateBlkStmtVal( 1, 1, 4 );
        Variable_c [] vars = Variable_c.VariableInstances(OalParserTest.modelRoot);
        assertEquals( 1, vars.length );
        OalParserTest.clearActionData(OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM);
    }
    ...
    public void testRelExprSDTNeOtherSDT() throws RecognitionException,
        ...
        String x = OalParserTest.parseAction(
                        "select any t from instances of D_TST;\nx = t.sdt_identity != t.sdt_pet1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testRelExprSDTEqOtherSDT() throws RecognitionException,
        ...
        String x = OalParserTest.parseAction(
                        ...
                        OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
                ":2:25-32: Incompatible operands for relational expression", lines[0]); //$NON-NLS-1$
        assertEquals("line 2:34: expecting Semicolon, found 'null'", lines[1]); //$NON-NLS-1$
    ...
    public void testRelExprSDTNeBool() throws RecognitionException,
            TokenStreamException {
        String x = OalParserTest.parseAction(
                        "select any t from instances of D_TST;\nx = t.sdt_identity != false;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testRelExprSDTNeEnum() throws RecognitionException,
        ...
        String x = OalParserTest
                .parseAction(
                        "select any t from instances of D_TST;\nx = t.sdt_identity != fruit::orange;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testRelExprSDTNeInt() throws RecognitionException,
        ...
        String x = OalParserTest
                .parseAction(
                        "select any t from instances of D_TST;\nx = t.sdt_identity != 1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testRelExprSDTNeReal() throws RecognitionException,
        ...
        String x = OalParserTest
                .parseAction(
                        "select any t from instances of D_TST;\nx = t.sdt_identity != 42.2;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testRelExprSDTNeString() throws RecognitionException,
        ...
        String x = OalParserTest
                .parseAction(
                        "select any t from instances of D_TST;\nx = t.sdt_identity != \"foo\";", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
                ":2:23-27: Incompatible operands for relational expression", lines[0]); //$NON-NLS-1$
        assertEquals("line 2:29: expecting Semicolon, found 'null'", lines[1]); //$NON-NLS-1$
    ...
    public void testRelExprSDTNeUDT() throws RecognitionException,
        ...
        String x = OalParserTest
                .parseAction(
                        "select any t from instances of D_TST;\nx = t.sdt_identity != t.u_bool;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
