//========================================================================
//
//File:      $RCSfile: TestControl.java,v $
...
public class TestControl extends TestCase {
	...
	public void testEmptyWhile() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("while (false)\n end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c act = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(act);
		...
		WhileStmt_c[] whl = WhileStmt_c.WhileStmtInstances(OalParserTest.modelRoot);
		...
		LiteralBoolean_c[] lbool = LiteralBoolean_c.LiteralBooleanInstances(OalParserTest.modelRoot);
	...
	public void testWhileBreak() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("while ( true )\n a = 1;\n break;\nend while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c act = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(act);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
		...
		assertEquals(whl[0].getValue_id(), lbool[0].getValue_id());
		Break_c[] break_stmt = Break_c.BreakInstances(OalParserTest.modelRoot);
	...
	public void testWhileContinue() throws RecognitionException, TokenStreamException {
		...
		assertEquals("TRUE", lbool[0].getValue());//$NON-NLS-1$
		assertEquals(whl[0].getValue_id(), lbool[0].getValue_id());
		Continue_c[] continue_stmt = Continue_c.ContinueInstances(OalParserTest.modelRoot);
	...
	public void testSimpleWhile1() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("i = 2;\n while (i < 10)\n i = 13;\n end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c act = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(act);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
		...
		TransientValueReference_c[] tv = TransientValueReference_c.TransientValueReferenceInstances(OalParserTest.modelRoot);
		...
		OalParserTest.verifyBinaryOperation(bin[0], "<", tv[1].getValue_id(), lin[1].getValue_id());//$NON-NLS-1$
		WhileStmt_c[] whl = WhileStmt_c.WhileStmtInstances(OalParserTest.modelRoot);
		assertEquals(1, whl.length);
	...
	public void testSimpleWhile2() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("i = true;\n while (i)\n z = \"test\"; \n i = false;\n end while;z = 2.2;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c act = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(act);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testSimpleWhile3() throws RecognitionException, TokenStreamException {
		...
		ModelClass_c testObj = ModelClass_c.ModelClassInstance(OalParserTest.modelRoot, new Object_test1_c());
		if (testObj == null) {
			testObj = new ModelClass_c(OalParserTest.modelRoot);
			testObj.setKey_lett("D_D");//$NON-NLS-1$
		}
		String x = OalParserTest.parseAction("i = 4;\n while (i == 4)\n create object instance d1 of D_D; \n i = 11;\n end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c act = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(act);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	private void validateForStmt( ForStmt_c x, UUID stmt_id, boolean isImplicit, UUID block_id,
		...
		InstanceSet_c[] irs_val = InstanceSet_c.InstanceSetInstances(OalParserTest.modelRoot);
	...
	public void testForSimpleImplicit() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  for each d in d_set a = 1; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		...
		ForStmt_c[] for_stmt = ForStmt_c.ForStmtInstances(OalParserTest.modelRoot);
	...
	public void testForSimpleImplicitWithReference() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  for each d in d_set x = empty d; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testForSimple() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select any d from instances of D_D; select many d_set from instances of D_D;  for each d in d_set a = 1; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testForSimpleWithReference() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select any d from instances of D_D; select many d_set from instances of D_D;  for each d in d_set x = empty d; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void test2ForSimpleWithReference() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select any d from instances of D_D; select many d_set from instances of D_D;  for each d in d_set x = empty d; end for; for each d in d_set x = empty d; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void test2ForSimpleImplicitWithReference() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  for each d in d_set x = empty d; end for; for each d in d_set x = empty d; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testForBreak() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  for each d in d_set a = 1; break; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testForContinue() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  for each d in d_set continue; a = 1; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testNestedBreak() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;\nfor each d in d_set\n  while ( true )\n   a = 1;\n   break;\n  end while;\n  b = 2;\n  break;\n end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
	...
	public void testIfOnly() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( false ) a = 1; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
		...
		IfStmt_c[] if_stmt = IfStmt_c.IfStmtInstances(OalParserTest.modelRoot);
	...
	public void testIfOnlyEmpty() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( false ) end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testIfElse() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( false ) a = 1; else b = 2; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
		...
		assertEquals(if_stmt[0].getBlock_id(), blk[1].getBlock_id());
		assertEquals(if_stmt[0].getValue_id(), val[0].getValue_id());
		ElseStmt_c[] else_stmt = ElseStmt_c.ElseStmtInstances(OalParserTest.modelRoot);
	...
	public void testIfEmptyElse() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( false ) else b = 2; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testIfElseEmpty() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( false ) a = 1; else end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testIfElif() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif ( false ) b = 2; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
		...
		assertEquals(if_stmt[0].getBlock_id(), blk[1].getBlock_id());
		assertEquals(if_stmt[0].getValue_id(), val[0].getValue_id());
		ElseifStmt_c[] elif_stmt = ElseifStmt_c.ElseifStmtInstances(OalParserTest.modelRoot);
	...
	public void testIfEmptyElif() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) elif ( false ) b = 2; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testIfElifEmpty() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif ( false ) end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testIf2Elif() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif ( false ) b = 2; elif ( false ) c = 3; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testIfElifElse() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif ( false ) b = 2; else c = 3; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testIf2ElifElse() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif ( false ) b = 2; elif ( false ) c = 3; else  d = 4; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Body_c action = Body_c.getOneACT_ACTOnR698(FunctionBody_c.getOneACT_FNBOnR695(OalParserTest.m_testFunc[OalParserTest.TEST_VOID_NO_PARM]));
		assertNotNull(action);
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
	...
	public void testForBadVarType() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  x = 1; for each x in d_set end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
	...
	public void testForWrongVarType() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select any h from instances of D_H; select many d_set from instances of D_D;  for each h in d_set end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		...
		OalParserTest.validateBlkStmtVal(1, 2, 0);
	}
	public void testForNotSetVar() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("x = 1; for each y in x end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testForNoSetVar() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("for each y in x end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testForWithEndWhile() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D; for each d in d_set end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
		assertEquals("line 1:66: expecting \"for\", found 'while'", lines[0]); //$NON-NLS-1$
		OalParserTest.validateBlkStmtVal(2, 2, 0);
	}
	public void testForWithEndIf() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D; for each d in d_set end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testForNoEnd() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D; for each d in d_set x = 1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
		...
		OalParserTest.validateBlkStmtVal(2, 3, 2);
	}
	public void testBreakBeforeWhileLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("break; while (true) end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testBreakAfterWhileLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("while (true) end while; break;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
		...
		OalParserTest.validateBlkStmtVal(2, 1, 1);
	}
	public void testBreakBeforeForLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  break; for each d in d_set end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testBreakAfterForLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  for each d in d_set end for; break;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
	...
	public void testBreakWithNoLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("break;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
		assertEquals(":1:1-5: Break statement can only be used in WHILE and FOR EACH block", lines[0]); //$NON-NLS-1$
	...
	public void testContinueBeforeWhileLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("continue; while (true) end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testContinueAfterWhileLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("while (true) end while; continue;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
	...
	public void testContinueBeforeForLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  continue; for each d in d_set end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testContinueAfterForLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("select many d_set from instances of D_D;  for each d in d_set end for; continue;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
	...
	public void testContinueWithNoLoop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("continue;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
		assertEquals(":1:1-8: Continue statement can only be used in WHILE and FOR EACH block", lines[0]); //$NON-NLS-1$
	...
	public void testIfNotBoolean() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( 1 ) a = 1; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
	...
	public void testIfWithEndFor() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
		assertEquals("line 1:24: expecting \"if\", found 'for'", lines[0]); //$NON-NLS-1$
		OalParserTest.validateBlkStmtVal(2, 2, 3);
	}
	public void testIfWithEndWhile() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testIfWithNoEnd() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
	...
	public void testIfElseWithEndFor() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; else b = 2; end for;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
		assertEquals("line 1:36: expecting \"if\", found 'for'", lines[0]); //$NON-NLS-1$
		OalParserTest.validateBlkStmtVal(3, 3, 5);
	}
	public void testIfElseWithEndWhile() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; else b = 2; end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testIfElseWithNoEnd() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; else b = 2;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
	...
	public void testElifNotBoolean() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif ( \"true\" ) b = 2; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testElifOutsideIf() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; end if; elif ( true ) b = 2; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testElseOutsideIf() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; end if; else b = 2; end if;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(1, lines.length);
	...
	public void testIfElifWithNoEnd() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif (false) b = 2;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
		...
		OalParserTest.validateBlkStmtVal(3, 4, 6);
	}
	public void testIfElifElseWithNoEnd() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif ( false ) b = 2; else c = 3;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
		...
		OalParserTest.validateBlkStmtVal(4, 5, 8);
	}
	public void testIf2ElifWithNoEnd() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif ( false ) b = 2; elif ( false ) c = 3;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
		...
		OalParserTest.validateBlkStmtVal(4, 6, 9);
	}
	public void testIf2ElifElseWithNoEnd() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("if ( true ) a = 1; elif ( false ) b = 2; elif ( false ) c = 3; else  d = 4;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
		assertEquals(2, lines.length);
		...
		OalParserTest.validateBlkStmtVal(5, 7, 11);
	}
	public void testWhileNonBooleanVar() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("x = 1; while (x)\n end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testWhileNonBooleanVar2() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("x = 1; while (x)\n x = 0; end while;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testControlStop() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("control stop;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x); //$NON-NLS-1$
		Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
		...
		assertEquals(1, st.length);
		assertEquals(blk[0].getBlock_id(), st[0].getBlock_id());
		Control_c[] ctl = Control_c.ControlInstances(OalParserTest.modelRoot);
    ...
    public void testCleanupBeforeContinuing() throws RecognitionException,
        ...
        for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
            OalParserTest.clearActionData(OalParserTest.ACTIVITY_TYPE_FUNC,
                    OalParserTest.TEST_VOID_NO_PARM);
            OalParserTest.clearActionData(OalParserTest.ACTIVITY_TYPE_FUNC,
                    OalParserTest.TEST_INT_NO_PARM);
            OalParserTest.clearActionData(OalParserTest.ACTIVITY_TYPE_FUNC,
                    OalParserTest.TEST_REAL_NO_PARM);
        }
    }
    public void testReturn() throws RecognitionException, TokenStreamException {
		for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
			String x = OalParserTest.parseAction("return;", i, OalParserTest.TEST_VOID_NO_PARM);//$NON-NLS-1$
			assertEquals("", x); //$NON-NLS-1$
			Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
			assertEquals(1, blk.length);
			Statement_c[] st = Statement_c.StatementInstances(OalParserTest.modelRoot);
			assertEquals(1, st.length);
			assertEquals(blk[0].getBlock_id(), st[0].getBlock_id());
			ReturnStmt_c[] ret = ReturnStmt_c.ReturnStmtInstances(OalParserTest.modelRoot);
			assertEquals(1, ret.length);
			assertEquals(st[0].getStatement_id(), ret[0].getStatement_id());
			OalParserTest.clearActionData(i, OalParserTest.TEST_VOID_NO_PARM);
		}
		for (int i = OalParserTest.STATE_ISM_NONE; i <= OalParserTest.STATE_ISM_POLYTWO; ++i) {
			String x = OalParserTest.parseAction("return;", OalParserTest.ACTIVITY_TYPE_STATE, i);//$NON-NLS-1$
			assertEquals("", x);
			Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
			assertEquals(1, blk.length);
			Statement_c[] st = Statement_c.StatementInstances(OalParserTest.modelRoot);
			...
			assertEquals(1, ret.length);
			assertEquals(st[0].getStatement_id(), ret[0].getStatement_id());
			OalParserTest.clearActionData(OalParserTest.ACTIVITY_TYPE_STATE, i);
		}
		for (int i = OalParserTest.TRANS_ISM_NONE; i <= OalParserTest.TRANS_CSM_THREE; ++i) {
			String x = OalParserTest.parseAction("return;", OalParserTest.ACTIVITY_TYPE_TRANSITION, i);//$NON-NLS-1$
			assertEquals("", x);
			Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
			assertEquals(1, blk.length);
			Statement_c[] st = Statement_c.StatementInstances(OalParserTest.modelRoot);
			...
			assertEquals(1, ret.length);
			assertEquals(st[0].getStatement_id(), ret[0].getStatement_id());
			OalParserTest.clearActionData(OalParserTest.ACTIVITY_TYPE_TRANSITION, i);
		}
	}
	public void testReturnSFromV() throws RecognitionException, TokenStreamException {
		...
		for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
			String x = OalParserTest.parseAction("return \"test\";", i, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
			String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testReturnIFromS() throws RecognitionException, TokenStreamException {
		...
		for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
			String x = OalParserTest.parseAction("return 7;", i, OalParserTest.TEST_STRING_NO_PARM); //$NON-NLS-1$
			String lines[] = x.split("\n");//$NON-NLS-1$
			assertEquals(err_msgs[i], lines[0]); //$NON-NLS-1$
			assertEquals("line 1:10: expecting Semicolon, found 'null'", lines[1]); //$NON-NLS-1$
			Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
			...
			Value_c[] val = Value_c.ValueInstances(OalParserTest.modelRoot);
			assertEquals(0, val.length);
			OalParserTest.clearActionData(i, OalParserTest.TEST_STRING_NO_PARM);
		}
	}
	public void testReturnVFromS() throws RecognitionException, TokenStreamException {
		...
		for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
			String x = OalParserTest.parseAction("return ;", i, OalParserTest.TEST_STRING_NO_PARM); //$NON-NLS-1$
			String lines[] = x.split("\n");//$NON-NLS-1$
			assertEquals(err_msgs[i], lines[0]); //$NON-NLS-1$
	...
	public void testNoReturnFromS() throws RecognitionException, TokenStreamException {
		...
		for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
			String x = OalParserTest.parseAction("", i, OalParserTest.TEST_STRING_NO_PARM); //$NON-NLS-1$
			String lines[] = x.split("\n");//$NON-NLS-1$
			assertEquals(1, lines.length);
	...
	public void testReturnIFromI() throws RecognitionException, TokenStreamException {
		for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
			String x = OalParserTest.parseAction("return 1;", i, OalParserTest.TEST_INT_NO_PARM); //$NON-NLS-1$
			assertEquals("", x); //$NON-NLS-1$
			Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
			assertEquals(1, blk.length);
			LiteralInteger_c[] lin = LiteralInteger_c.LiteralIntegerInstances(OalParserTest.modelRoot);
			...
			OalParserTest.clearActionData(i, OalParserTest.TEST_INT_NO_PARM);
		}
	}
	public void testReturnRFromR() throws RecognitionException, TokenStreamException {
		for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
			String x = OalParserTest.parseAction("return 1.1;", i, OalParserTest.TEST_REAL_NO_PARM); //$NON-NLS-1$
			assertEquals("", x); //$NON-NLS-1$
			Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
			assertEquals(1, blk.length);
			Value_c[] val = Value_c.ValueInstances(OalParserTest.modelRoot);
			...
			OalParserTest.clearActionData(i, OalParserTest.TEST_REAL_NO_PARM);
		}
	}
	public void testReturnIFromR() throws RecognitionException, TokenStreamException {
		for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
			String x = OalParserTest.parseAction("return 1;", i, OalParserTest.TEST_REAL_NO_PARM); //$NON-NLS-1$
			assertEquals("", x); //$NON-NLS-1$
			Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
			assertEquals(1, blk.length);
			LiteralInteger_c[] lin = LiteralInteger_c.LiteralIntegerInstances(OalParserTest.modelRoot);
    ...
    public void testReturnRFromI() throws RecognitionException, TokenStreamException {
        for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
            String x = OalParserTest.parseAction("return 1.1;", i, OalParserTest.TEST_INT_NO_PARM); //$NON-NLS-1$
            assertEquals("", x); //$NON-NLS-1$
            Block_c[] blk = Block_c.BlockInstances(OalParserTest.modelRoot);
            assertEquals(1, blk.length);
            LiteralReal_c[] lreal = LiteralReal_c.LiteralRealInstances(OalParserTest.modelRoot);
