//========================================================================
//
//File:      $RCSfile: TestAttribute.java,v $
...
public class TestAttribute extends TestCase {
	...
	public void validateAttributeRead(String act, String kl, String typeName, String [] vars) throws RecognitionException, TokenStreamException {
		...
		UUID typeId = BaseTest.getTypeID(OalParserTest.modelRoot, typeName);
        UUID objId = BaseTest.getTypeID(OalParserTest.modelRoot, "inst_ref<Object>");
		...
		InstanceReference_c[] ir = InstanceReference_c.InstanceReferenceInstances(OalParserTest.modelRoot);
	...
	public void testBadAttributeRead() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("create object instance d1 of D_D; \nx = d1.Bad_Attribute;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
	 ...
	 public void testAttributeWrite() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("create object instance d1 of D_D; \nd1.Disk_ID = 1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x);//$NON-NLS-1$
	...
	public void testAttributeWriteWithUnderscores() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("create object instance d1 of _T; \nd1._attr = 1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x);//$NON-NLS-1$
		UUID intId = BaseTest.getTypeID(OalParserTest.modelRoot, "integer");//91//$NON-NLS-1$
	...
	public void testAttributeWriteSelf() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("self.Row_Number = 1;", OalParserTest.ACTIVITY_TYPE_IB_OP, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		assertEquals("", x);//$NON-NLS-1$
		UUID intId = BaseTest.getTypeID(OalParserTest.modelRoot, "integer");//91//$NON-NLS-1$
	...
	public void testAttributeWriteSelfFromTransition() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("self.u_int = 1;", OalParserTest.ACTIVITY_TYPE_TRANSITION, OalParserTest.TRANS_ISM_NONE); //$NON-NLS-1$
		assertEquals("", x);//$NON-NLS-1$
		...
		OalParserTest.clearActionData(OalParserTest.ACTIVITY_TYPE_TRANSITION, OalParserTest.TRANS_ISM_NONE);
	}
	...
	public void testAttributeWriteBadName() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("create object instance d1 of D_D; \nd1.Bad_Attribute = 1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testAttributeWriteBad2CurrentState() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("create object instance d1 of D_D; \nd1.current_state = 1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testAttributeWriteBad2RefAttr() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("create object instance d1 of D_D; \nd1.Row_Number = 2;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testAttributeWriteBad2MDA() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("create object instance d1 of D_D; \nd1.mda = \"bad\";", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testAttributeWriteBad2ID() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("create object instance d1 of D_D; \ncreate object instance d2 of D_D;\nd1.id2 = d2.id2;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
	...
	public void testAttributeWriteS2I() throws RecognitionException, TokenStreamException {
		String x = OalParserTest.parseAction("create object instance d1 of D_D; \nd1.Disk_ID = \"x\";", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
		String lines[] = x.split("\n");//$NON-NLS-1$
