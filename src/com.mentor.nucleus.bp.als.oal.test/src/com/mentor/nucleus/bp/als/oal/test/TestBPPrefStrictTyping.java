//========================================================================
//
//File:      $RCSfile: TestBPPrefStrictTyping.java,v $
...
public class TestBPPrefStrictTyping extends TestCase {

    private TestAssign assignTest = new TestAssign();
    private TestExpr exprTest = new TestExpr();
    private TestAttribute attrTest = new TestAttribute();
	...
	public void assignTypeMismatchTest(String stmts, UUID dt1, UUID dt2,
		...
		Instance_c[] iv = Instance_c.InstanceInstances(OalParserTest.modelRoot);
    ...
    public void testAssignTypeMismatchIV2RV() throws RecognitionException,
            TokenStreamException {
        ...
        assignTypeMismatchTest("x = 5.13;\ny = 99;\nx = y;\n ", id1, id2, 2, 0, 0); //$NON-NLS-1$
    }
	...
	public void testAssignUDT2Real() throws RecognitionException, TokenStreamException {
 	...
 	public void testAssignInt2RealUDT() throws RecognitionException, TokenStreamException {
        ...
        assertEquals(":1:50-51: Attribute ->u_real<- is a different type", lines[0]);
	...
	public void testAssignIntUDT2Real() throws RecognitionException, TokenStreamException {
        ...
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(2, lines.length);
        assertEquals(":1:54-58: Variable ->x<- already exists as a different type", lines[0]);
        assertEquals("line 1:60: expecting Semicolon, found 'null'", lines[1]);
        OalParserTest.validateBlkStmtVal( 1, 2, 4 );
	}
    ...
    public void testAddExprI2I2R() throws RecognitionException,
        ...
        String x = OalParserTest.parseAction(
                "x = 1 + 2 - 2.4;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testAddExprI2R2I() throws RecognitionException,
            TokenStreamException {
        String x = OalParserTest.parseAction(
                "x = 1 + 2.0 - 3;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testAddExprR2I2I() throws RecognitionException,
            TokenStreamException {
        String x = OalParserTest.parseAction(
                "x = .7 + 2 - 3;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testAddExprI2R2R() throws RecognitionException,
            TokenStreamException {
        String x = OalParserTest.parseAction(
                "x = 1 + 9.2 - 2.4;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
                ":1:9-11: Incompatible operands for addition expression", lines[0]); //$NON-NLS-1$
    }
    ...
    public void testAddExprR2I2R() throws RecognitionException,
            TokenStreamException {
        String x = OalParserTest.parseAction(
                "x = 1.11 + 2 - 3.14;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testAddExprR2R2I() throws RecognitionException,
            TokenStreamException {
        String x = OalParserTest.parseAction(
                "x = .99 + 0.01 - 3;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testAddExprR2R() throws RecognitionException,
        ...
        LiteralReal_c[] lr = LiteralReal_c
                .LiteralRealInstances(OalParserTest.modelRoot);
    ...
    public void testAddExprR2I() throws RecognitionException,
            TokenStreamException {
        String x = OalParserTest.parseAction(
                "x = 2.3 + 1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
    ...
    public void testUnaryPlusI() throws RecognitionException,
        ...
        String x = OalParserTest
                .parseAction(
                        "x = +2;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        assertEquals("", x);//$NON-NLS-1$
        Variable_c[] t = Variable_c.VariableInstances(OalParserTest.modelRoot);
        assertEquals(1, t.length);
        assertEquals("x", t[0].getName());//$NON-NLS-1$
    ...
    public void testRelExprI2R() throws RecognitionException,
        ...
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(
                ":1:9-11: Incompatible operands for relational expression", lines[0]); //$NON-NLS-1$
        assertEquals("line 1:13: expecting Semicolon, found 'null'", lines[1]); //$NON-NLS-1$
        Statement_c[] st = Statement_c
                .StatementInstances(OalParserTest.modelRoot);
        ...
        LiteralReal_c[] lreal = LiteralReal_c
                .LiteralRealInstances(OalParserTest.modelRoot);
        assertEquals(0, lreal.length);
    }
    ...
    public void testBadAttributeWriteI2R() throws RecognitionException, TokenStreamException {
        String x = OalParserTest.parseAction("create object instance d1 of D_D; \nd1.real_attr = 1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
        assertEquals(":2:16-16: Attribute ->real_attr<- is a different type", lines[0]); //$NON-NLS-1$
    ...
    public void testBadAttributeWriteR2I() throws RecognitionException, TokenStreamException {
        String x = OalParserTest.parseAction("create object instance d1 of D_D; \nd1.Disk_ID = 1.1;", OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_VOID_NO_PARM); //$NON-NLS-1$
        String lines[] = x.split("\n");//$NON-NLS-1$
    ...
    public void testCleanupBeforeContinuing() throws RecognitionException, TokenStreamException {
        ...
        OalParserTest.clearActionData(OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_INT_NO_PARM);
        OalParserTest.clearActionData(OalParserTest.ACTIVITY_TYPE_FUNC, OalParserTest.TEST_REAL_NO_PARM);
    ...
    public void testReturnIFromR() throws RecognitionException, TokenStreamException {
        for (int i = OalParserTest.ACTIVITY_TYPE_FUNC; i <= OalParserTest.ACTIVITY_TYPE_IB_OP; ++i) {
            ...
            assertEquals(":1:8-8: Invalid data type returned", errmsg[0]); //$NON-NLS-1$
