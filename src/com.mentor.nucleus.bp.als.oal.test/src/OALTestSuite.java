//=====================================================================
//
//File:      $RCSfile: OALTestSuite.java,v $
...
import com.mentor.nucleus.bp.als.oal.test.TestSelectWhere;
import com.mentor.nucleus.bp.als.oal.test.TestStructuredDataType;

public class OALTestSuite extends TestSuite {

	public static Test suite() {
		return new OALTestSuite();
	}
	public OALTestSuite() {
	    ...
	    addTest(new TestSuite(TestSelectWhere.class));
	}
}
