//========================================================================
//
//File:      $RCSfile: NewMCTestWizard1.java,v $
...
// the License.
//======================================================================== 
package org.xtuml.internal.test;
...
public class NewMCTestWizard1 extends DelegatingWizard {
  ...
  /* (non-Javadoc)
   * @see org.xtuml.bp.core.ui.DelegatingWizard#getExtensionPoint()
   */
  public String getExtensionPoint() {
    return "org.xtuml.code-builders"; // $NON-NLS-1$
  }

  public static IWorkbenchWizard getWizard() {
    return new NewMCTestWizard1();
  }
  ...
  public boolean performFinish(IProject newProject) {
    System.out.println("MCTestWizard 1 Finishing project: " + newProject.getName());
