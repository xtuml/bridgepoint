//====================================================================
//
// File:      $RCSfile: VerifyPreBuilderPresentAction.java,v $
...
public class VerifyPreBuilderPresentAction implements IActionDelegate {

	@Override
	public void run(IAction action) {
        ModelCompiler.verifyProjectBuilders();
	}
