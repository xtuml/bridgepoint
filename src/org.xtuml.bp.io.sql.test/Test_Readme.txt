...
- On the Test tab, under 'Run a single test', specify 
  project 'org.xtuml.bp.io.sql.test' and test class 'IOSqlTestSuite'
- Change workspace data to '${eclipse_home}/bp_tests/io_sql'
- Change VM Arguments to 
  '-DWORKSPACE_PATH=${workspace_loc}/org.xtuml.bp.io.sql.test/ -DLOGFILE_PATH=${eclipse_home}/bp_tests/io_sql/.metadata/.log'
