...
//====================================================================
//
// File:      $RCSfile: TypeDefinitionEditor.java,v $
...
public class TypeDefinitionEditor extends AbstractModelElementTextEditor
{
	...
	protected class Listener implements IDocumentListener
	{
	  public void documentChanged(DocumentEvent ev)
	  {
		...
		if (provider instanceof DocumentProvider)
		{
		  ...
		  {
			TypeDefinitionEditorInput de_input = (TypeDefinitionEditorInput) input;
  ...
  {
    /*
     * TypeDefinition editor has its own configuration class (Inner class to this 
	...
	if ( textWidget != null )
	{
		...
		focusListener = new FocusListener() {
			public void focusGained(FocusEvent ev) {
				Object selObj = ((TypeDefinitionEditorInput)getEditorInput()).getModelElement();
				if(selObj != null){
	...
	PlatformUI.getWorkbench().getHelpSystem().setHelp(textWidget, IUITextHelpContextIds.typedefinitionEditorId);
  }
  public void dispose()
  {
	if ( listener != null )
  ...
  public Image getTitleImage() {
	  Object element = ((TypeDefinitionEditorInput)this.getEditorInput()).getModelElement();;
  ...
  class Configuration extends SourceViewerConfiguration{
      ...
      Configuration(){
          ...
          hover.setEditor(TypeDefinitionEditor.this);
      }
