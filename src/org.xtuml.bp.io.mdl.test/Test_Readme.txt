...
- On the Test tab, under 'Run a single test', specify
  project 'org.xtuml.bp.io.mdl.test' and test class 'IOMdlTestSuite'
- Change workspace data to '${eclipse_home}/bp_tests/io_mdl'
- Change VM Arguments to
  '-DWORKSPACE_PATH=${workspace_loc}/org.xtuml.bp.io.mdl.test/ -DLOGFILE_PATH=${eclipse_home}/bp_tests/io_mdl/.metadata/.log'
...
- On the Plug-ins and Fragments page, check the bottom radio button.
   ...
   _- Disable (uncheck) the following external plugins
   		org.xtuml.builder.welcome
   		org.xtuml.debug*
   		org.xtuml.target.windows
   		org.xtuml.ts*
...
- Project    : org.xtuml.bp.io.mdl.test
- Test Class : org.xtuml.bp.io.mdl.test.pkgcm.restore.PkgCMRestoreTestSuite
- Location   : bp_tests/pkgCM_mdl
- VM Argument: -DWORKSPACE_PATH=${workspace_loc}/org.xtuml.bp.io.mdl.test/
...
- Name : testcase0
- Value: org.xtuml.bp.io.mdl.test.pkgcm.PkgCMCreateTest
...
For example another testcase class can be added to suite .
  name  = testcase1
  value = org.xtuml.bp.io.mdl.test.pkgcm.PkgCMRenameTest
