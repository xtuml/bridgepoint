...
//=====================================================================
//
//File:      $RCSfile: PolymorphicEventComparable.java,v $
...
public class PolymorphicEventComparable extends NonRootModelElementComparable {
	...
	public boolean treeItemEquals(Object other) {
		if (!super.treeItemEquals(other)) {
			...
			// are equal
			if (other instanceof SemEventComparable) {
				SemEventComparable sem = (SemEventComparable) other;
				SemEvent_c semEvt = (SemEvent_c) sem.getRealElement();
				PolymorphicEvent_c poly = (PolymorphicEvent_c) getRealElement();
				if(poly.getSmevt_idCachedValue().equals(semEvt.getSmevt_idCachedValue())) {
					return true;
				} else {
					return false;
				}
	...
	public boolean treeItemValueEquals(Object other) {
		if(treeItemEquals(other) && !(other instanceof PolymorphicEventComparable)) {
			return false;
		}
		return true;
	}
