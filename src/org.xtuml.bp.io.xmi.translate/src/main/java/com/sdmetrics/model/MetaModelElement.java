...
public class MetaModelElement {
	...
	public static class MetaModelElementAttribute {
		 ...
		 */
		MetaModelElementAttribute(String name, String mapping, boolean isRef, boolean isSet,
				int index) {
			this.attrName = name;
	 ...
	 */
	MetaModelElement(String name, String mapping, MetaModelElement parent) {
		this.typeName = name;
		this.mapping = mapping;
		if (parent != null) {
	 ...
	 */
	void addAttribute(String attrName, String mapping, boolean isRef, boolean isSet) {
		MetaModelElementAttribute attrib = new MetaModelElementAttribute(
				attrName, mapping, isRef, isSet, attributes.size());
	 ...
	 * @throws IllegalArgumentException Element type has no such attribute.
	 */
	public MetaModelElementAttribute getAttribute(String name) {
