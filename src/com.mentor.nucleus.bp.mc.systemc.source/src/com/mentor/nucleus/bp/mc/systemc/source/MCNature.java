...
public class MCNature extends AbstractNature {
	 ...
	 */
	public static final String MC_NATURE_ID = "com.mentor.nucleus.bp.mc.systemc.source.MCNature"; //NON-NLS-1

	/**
	 * identifier of this nature in plugin.xml - (concatenate
	 * pluginid.exportbuilderid)
	 */
	public static final String EXPORT_BUILDER_ID = "com.mentor.nucleus.bp.mc.systemc.source.export_builder"; //NON-NLS-1
