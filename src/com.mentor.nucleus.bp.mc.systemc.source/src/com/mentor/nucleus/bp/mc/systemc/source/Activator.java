...
public class Activator extends AbstractActivator implements IStartup {
	...
	public static final String PLUGIN_ID = "com.mentor.nucleus.bp.mc.systemc.source";
	...
	public void verifyProjectBuilders() {
		super.verifyProjectBuilders(MCNature.getDefault(),
				MCNature.EDGE_NATURE_ID, MCNature.EXPORT_BUILDER_ID);
	}
}
