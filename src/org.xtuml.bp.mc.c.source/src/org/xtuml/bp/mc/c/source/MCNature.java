...
public class MCNature extends AbstractNature {
	 ...
	 */
	public static final String MC_NATURE_ID = "org.xtuml.bp.mc.c.source.MCNature"; //NON-NLS-1
	public static final String MC_NATURE_ID_OLD = "com.mentor.nucleus.bp.mc.c.source.MCNature"; //NON-NLS-1

	/**
	 * identifier of this nature in plugin.xml - (concatenate
	 * pluginid.exportbuilderid)
	 */
	public static final String EXPORT_BUILDER_ID = "org.xtuml.bp.mc.c.source.export_builder"; //NON-NLS-1
