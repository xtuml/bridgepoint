...
public class VerifierInterfaceExecutionTests extends BaseTest {
    ...
    public void testInterfaceExecutionSignalAssignedToTransition() {
        ...
        RequiredOperation_c reqOp = RequiredOperation_c
                .getOneSPR_ROOnR4502(
                        RequiredExecutableProperty_c.getManySPR_REPsOnR4500(Requirement_c.getManyC_RsOnR4009(InterfaceReference_c
    ...
    public void testInterfaceExecutionSignalParametersAssignedToTransition() {
        ...
        assertTrue("Process was not suspended by breakpoint in state.",
                target.isSuspended());
         ...
         * assertEquals(
         * "Default parameter value was not as expected for variable x.", "2",
         * xValue); String yValue =
         * DebugUITestUtilities.getValueForVariable("y"); assertEquals(
         * "Default parameter value was not as expected for variable y.", "4",
         * yValue);
         */
        // compare the trace
        File expectedResults = new File(
    ...
    public void testInterfaceExecutionSignalWithQueuedEventsBadState() {
        ...
        StateMachineState_c state = StateMachineState_c
                .getOneSM_STATEOnR501(
                        StateMachine_c.getManySM_SMsOnR517(ClassStateMachine_c.getManySM_ASMsOnR519(ModelClass_c.getManyO_OBJsOnR8001(
                                ...
                                new ClassQueryInterface_c() {
                                    ...
                                    @Override
                                    public boolean evaluate(Object candidate) {
                                        return ((ModelClass_c) candidate)
                                                .getName().equals("cls 2");
                                    }
                                }))), new ClassQueryInterface_c() {
        ...
        ModelClass_c startClass = ModelClass_c.getOneO_OBJOnR8001(
                PackageableElement_c.getManyPE_PEsOnR8000(Package_c
                        .getManyEP_PKGsOnR8001(PackageableElement_c
                                .getManyPE_PEsOnR8003(component))),
                new ClassQueryInterface_c() {
        ...
        Operation_c op = Operation_c.getOneO_TFROnR115(startClass,
                new ClassQueryInterface_c() {

                    public boolean evaluate(Object candidate) {
                        return ((Operation_c) candidate).getName().equals(
                                "start_test_bad_state");
                    }
        ...
        ProvidedOperation_c proOp = ProvidedOperation_c.getOneSPR_POOnR4503(
                ...
                new ClassQueryInterface_c() {
                    ...
                    public boolean evaluate(Object candidate) {
                        return ((ProvidedOperation_c) candidate).getName()
                                .equals("sendClientServer");
                    }
    ...
    public void testInterfaceExecutionSignalNotAssignedWithOAL() {
        ...
        IDebugTarget target = process.getLaunch().getDebugTarget();
        assertTrue(
                "Process was not suspended by breakpoint in required signal.",
                target.isSuspended());
    ...
    public void testInterfaceExecutionSignalNotAssignedWithNoOAL() {
        ...
        IDebugTarget target = process.getLaunch().getDebugTarget();
        assertTrue(
                "Process was not suspended by breakpoint in requied operation.",
                target.isSuspended());
        ...
        assertEquals(
                "Port3::Interface Server Client 2::sendServerClientNoOAL line: 4",
                topFrameText);
    ...
    public void testInterfaceExecutionSignalNotAssignedCurrentExecutingAction() {
        ...
        /*
         * String actual_results = DebugUITestUtilities
         * .getConsoleText(expected_results); assertEquals(expected_results,
         * actual_results);
         */}
    ...
    // DebugUITestUtilities.openActivityEditorForSelectedElement();
    // DebugUITestUtilities.setBreakpointAtLine(editor, 2);
    //
    // BPDebugUtils.setSelectionInSETree(new StructuredSelection(proOp));
    //
    ...
    //
    // IDebugTarget target = process.getLaunch().getDebugTarget();
    // assertTrue("Process was not suspended by breakpoint in provided operation.",
    // target
    // .isSuspended());
    //
    ...
    //
    // String topFrameText = DebugUITestUtilities.getTopFrameText(engine);
    // assertEquals("Port4::Interface Client Server 2::sendClientServerOALVoidReturn line: 2",
    // topFrameText);
    //
    // // compare the trace
    // File expectedResults = new File(
    ...
    public void testInterfaceExectuionOperationOALNonVoidReturn() {
        ...
        ProvidedOperation_c proOp = ProvidedOperation_c.getOneSPR_POOnR4503(
                ...
                new ClassQueryInterface_c() {
                    ...
                    public boolean evaluate(Object candidate) {
                        return ((ProvidedOperation_c) candidate).getName()
                                .equals("sendClientServerOALNonVoidReturn");
                    }

                });
        assertNotNull(proOp);

        ProvidedOperation_c testOp = ProvidedOperation_c.getOneSPR_POOnR4503(
                ProvidedExecutableProperty_c.getManySPR_PEPsOnR4501(Provision_c
                        .getManyC_PsOnR4009(InterfaceReference_c
                                .getManyC_IRsOnR4016(Port_c
                                        .getManyC_POsOnR4010(component,
                ...
                new ClassQueryInterface_c() {
                    ...
                    public boolean evaluate(Object candidate) {
                        return ((ProvidedOperation_c) candidate).getName()
                                .equals("clientServerOALNonVoidReturn");
                    }
        ...
        IDebugTarget target = process.getLaunch().getDebugTarget();
        assertTrue(
                "Process was not suspended by breakpoint in provided operation.",
                target.isSuspended());
        ...
        String topFrameText = DebugUITestUtilities.getTopFrameText(engine);
        assertEquals(
                "Port4::Interface Client Server 2::sendClientServerOALNonVoidReturn line: 2",
                topFrameText);
    ...
    public void testInterfaceExecutionOperationNoOALVoidReturn() {
        ...
        ProvidedOperation_c proOp = ProvidedOperation_c.getOneSPR_POOnR4503(
                ...
                new ClassQueryInterface_c() {
                    ...
                    public boolean evaluate(Object candidate) {
                        return ((ProvidedOperation_c) candidate).getName()
                                .equals("sendClientServerNoOALVoidReturn");
                    }
        ...
        ProvidedOperation_c testOp = ProvidedOperation_c.getOneSPR_POOnR4503(
                ...
                new ClassQueryInterface_c() {
                    ...
                    public boolean evaluate(Object candidate) {
                        return ((ProvidedOperation_c) candidate).getName()
                                .equals("clientServerNoOALVoidReturn");
                    }
        ...
        String topFrameText = DebugUITestUtilities.getTopFrameText(engine);
        assertEquals(
                "Port4::Interface Client Server 2::sendClientServerNoOALVoidReturn line: 3",
                topFrameText);
    ...
    public void testInterfaceExecutionOperationNoOALNonVoidReturn() {
        ...
        ProvidedOperation_c proOp = ProvidedOperation_c.getOneSPR_POOnR4503(
                ...
                new ClassQueryInterface_c() {
                    ...
                    public boolean evaluate(Object candidate) {
                        return ((ProvidedOperation_c) candidate).getName()
                                .equals("sendClientServerNoOALNonVoidReturn");
                    }
        ...
        ProvidedOperation_c testOp = ProvidedOperation_c.getOneSPR_POOnR4503(
                ...
                new ClassQueryInterface_c() {
                    ...
                    public boolean evaluate(Object candidate) {
                        return ((ProvidedOperation_c) candidate).getName()
                                .equals("clientServerNoOALNonVoidReturn");
                    }
        ...
        String topFrameText = DebugUITestUtilities.getTopFrameText(engine);
        assertEquals(
                "Port4::Interface Client Server 2::sendClientServerNoOALNonVoidReturn line: 3",
                topFrameText);
    ...
    public void testInterfaceExecutionOperationWithParamatersNonVoidReturn() {
        ...
        ProvidedOperation_c proOp = ProvidedOperation_c.getOneSPR_POOnR4503(
                ...
                new ClassQueryInterface_c() {
                    ...
                    public boolean evaluate(Object candidate) {
                        return ((ProvidedOperation_c) candidate).getName()
                                .equals("sendClientServerParamsNonVoidReturn");
                    }
        ...
        ProvidedOperation_c testOp = ProvidedOperation_c.getOneSPR_POOnR4503(
                ...
                new ClassQueryInterface_c() {
                    ...
                    public boolean evaluate(Object candidate) {
                        return ((ProvidedOperation_c) candidate).getName()
                                .equals("clientServerParamsNonVoidReturn");
                    }
