...
.assign path = "org/xtuml/bp/core/ui/cells"
.if(output_path != "")
  .assign path = output_path
.end if
.assign rel_path = "src/${path}"
.assign package_initial = "org.xtuml.bp.core.ui.cells"
.if(source_package != "")
...
import org.xtuml.bp.core.ui.cells.ICellProvider;
...
import org.xtuml.bp.core.*;
.else
import org.xtuml.bp.core.ui.cells.*;
import org.xtuml.bp.ui.canvas.*;
.end if
import org.xtuml.bp.core.common.*;
import org.xtuml.bp.core.inspector.ObjectElement;
.if(root == "Ooaofooa")
import org.xtuml.bp.core.ui.cells.providers.*;
.else
import org.xtuml.bp.ui.canvas.cells.providers.*;
.end if
