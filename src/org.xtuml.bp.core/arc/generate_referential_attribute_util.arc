...
public class ReferentialAttributeUtil implements IReferentialAttributeManager {

    private static IReferentialAttributeManager defaultInstance = null;

    private ReferentialAttributeUtil() {
        super();
    }

    public static IReferentialAttributeManager getInstance() {
        if ( null == defaultInstance ) defaultInstance = new ReferentialAttributeUtil();
...
.// MAIN CODE
.//
.invoke ref_attr_util_class = genReferentialAttributeUtilClass()
//======================================================================================
//
// File: org.xtuml.bp.core/src/org/xtuml/bp/core/util/ReferentialAttributeUtil.java
//
...
.//
.emit to file "src/org/xtuml/bp/core/util/ReferentialAttributeUtil.java"
.//
