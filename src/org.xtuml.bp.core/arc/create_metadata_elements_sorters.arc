.//=====================================================================
.//
.// File:      create_metadata_elements_sorters.arc
.//
.//=====================================================================
...
public class ${attr_sorter_class_name} extends BaseTypeSpecificSorter {
    ...
    .if ("${sorting_relation.Numb}" == "1505")
			LiteralSymbolicConstant_c ${sorter_var_name} = LiteralSymbolicConstant_c.getOneCNST_LSCOnR1503(LeafSymbolicConstant_c.getManyCNST_LFSCsOnR1502(SymbolicConstant_c.getManyCNST_SYCsOnR1505Precedes(SymbolicConstant_c.getManyCNST_SYCsOnR1502(LeafSymbolicConstant_c.getManyCNST_LFSCsOnR1503(${sorter_var_name}s[index])))));
    .else
