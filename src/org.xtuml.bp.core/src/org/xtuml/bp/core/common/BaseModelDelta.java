...
public class BaseModelDelta implements IModelDelta {
	...
	/* (non-Javadoc)
	 * @see org.xtuml.bp.core.common.IModelDelta#getKind()
	 */
	public int getKind() {
		return kind;
	}
	...
	/* (non-Javadoc)
	 * @see org.xtuml.bp.core.common.IModelDelta#getModelElement()
	 */
	...
	/* (non-Javadoc)
	 * @see org.xtuml.bp.core.common.IModelDelta#setModelElement()
	 */
