package org.xtuml.bp.core.ui.perspective;
//====================================================================
//
...
public class BridgePointPerspective implements IPerspectiveFactory {
  public static final String ID_MGC_BP_EXPLORER = "org.xtuml.bp.ui.explorer.ExplorerView";//$NON-NLS-1$
  /* (non-Javadoc)
...
//  Get the editor area.
  ...
  layout.addNewWizardShortcut("org.xtuml.bp.NewWizardSystem");//$NON-NLS-1$
  layout.addNewWizardShortcut("org.xtuml.bp.NewWizardDomain");//$NON-NLS-1$
                          
  layout.addPerspectiveShortcut("org.xtuml.bp.debug.ui.DebugPerspective");//$NON-NLS-1$
