...
/**
 *
 * This wizard implementation manages passing wizard interface calls to a
 * downstream partner (aslo assumed to implement IWizard).
 * 
 */
public class WizardDelegate implements IWizard {
    ...
    public void createPageControls(Composite pageContainer) {
        CorePlugin.logError("WizardDelegate.createPageControls called illegally.", null);
    }
    ...
    public IWizardContainer getContainer() {
        CorePlugin.logError("WizardDelegate.getContainer called illegally.", null);
        return null;
    }
    ...
    public RGB getTitleBarColor() {
        CorePlugin.logError("WizardDelegate.getTitleBarColor called illegally.", null);
        return null;
    }
    ...
    public String getWindowTitle() {
        CorePlugin.logError("WizardDelegate.getWindowTitle called illegally.", null);
        return null;
    }
    ...
    /*
     * (non-Javadoc) Peform finish in the case where the resource is already
     * created. Call this method after performing own finish processing.
     */
    public boolean performFinish(IProject project) {
        if (delegate != null) {
            ...
            try {
                Method performFinish = delegate.getClass().getMethod("performFinish", argTypes); //$NON-NLS-1$
                Object[] args = new Object[1];
                args[0] = project;
                Object result = performFinish.invoke(delegate, args);
                return ((Boolean) result).booleanValue();
            } catch (NoSuchMethodException e) {
                CorePlugin.logError("No performFinish method found for downstream wizard: ", e);
                ...
                CorePlugin.logError("performFinish method does not return a Boolean value: ", e);
            }
        }
        return true;
    }
    ...
    public void setContainer(IWizardContainer wizardContainer) {
        CorePlugin.logError("WizardDelegate.setContainer called illegally.", null);
    }
        ...
        if (delegateProvider != null) {
            ...
            try {
                ...
                if (e instanceof NoSuchMethodException) {
                    ...
                    CorePlugin.logError("getWizard method does not return an instance of IWizard: ", e);
                } else {
                    CorePlugin.logError("Unexpected exception encountered: ", e);
                }
            }
        }
        return null;
