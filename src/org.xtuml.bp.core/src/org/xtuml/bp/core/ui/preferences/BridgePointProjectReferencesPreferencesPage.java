...
public class BridgePointProjectReferencesPreferencesPage extends PropertyPage {
    
    BridgePointProjectPreferences page;
    
    public BridgePointProjectReferencesPreferencesPage() {
        page = null;
    }
    ...
    protected Control createContents(Composite parent) {
        ...
        page = new BridgePointProjectReferencesPreferences(projectNode);
