...
public class BridgePointProjectDependenciesPreferencesPage extends PropertyPage {
    
    BridgePointProjectPreferences page;
    
    public BridgePointProjectDependenciesPreferencesPage() {
        page = null;
    }
    ...
    protected Control createContents(Composite parent) {
        ...
        page = new BridgePointProjectDependenciesPreferences(projectNode);
