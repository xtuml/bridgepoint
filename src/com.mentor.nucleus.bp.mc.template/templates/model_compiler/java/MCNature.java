...
public class MCNature extends AbstractNature {
	 ...
	 */
	public static final String MC_NATURE_ID = "$packageName$.MCNature"; //$NON-NLS-1$

	/**
	 * identifier of this nature in plugin.xml - (concatenate
	 * pluginid.exportbuilderid)
	 */
	public static final String EXPORT_BUILDER_ID = "$packageName$.export_builder"; //$NON-NLS-1$
