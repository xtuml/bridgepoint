...
public interface IBPBreakpoint {
	...
	public static final String BREAKPOINT_ID = "org.xtuml.bp.debug.ui.bpBreakpoint.marker"; //$NON-NLS-1$
	...
	public static final String LINE_BREAKPOINT_ID = "org.xtuml.bp.debug.ui.lineBreakpoint.marker"; //$NON-NLS-1$
	public static final String MODELROOT_ID = "org.xtuml.bp.debug.core.modelRootId"; //$NON-NLS-1$
	public static final String MODELELEMENT_ID = "org.xtuml.bp.debug.core.modelElementId"; //$NON-NLS-1$
	public static final String LOCATION = "org.xtuml.bp.debug.core.location"; //$NON-NLS-1$
	public static final String HIT_COUNT = "org.xtuml.bp.debug.core.hitCount"; //$NON-NLS-1$
	public static final String CONDITION = "org.xtuml.bp.debug.core.condition"; //$NON-NLS-1$
	public static final String CONDITION_ENABLED = "org.xtuml.bp.debug.core.conditionEnabled"; //$NON-NLS-1$
	public static final String BP_TYPE = "org.xtuml.bp.debug.core.bpType"; //$NON-NLS-1$
	public static final String FLAGS = "org.xtuml.bp.debug.core.flags"; //$NON-NLS-1$

	public static final String VERIFIER_BREAKPOINT_ID = "org.xtuml.bp.debug.ui.verifierException.marker"; //$NON-NLS-1$
	public static final String VERIFIER_BREAKPOINT_TYPE_ID = "org.xtuml.bp.debug.core.exceptionName"; //$NON-NLS-1$
