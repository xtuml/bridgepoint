...
import org.xtuml.bp.core.ui.preferences.VerifierPreferences;
import org.xtuml.bp.core.ui.tree.ModelCheckedTreeViewer;
import org.xtuml.bp.core.ui.tree.SpinnerBoxCellEditor;
...
public class VerifiableElementComposite extends Composite implements Listener,
    ...
    // update
    private ListenerList updateListenerList = new ListenerList(ListenerList.IDENTITY);
    ...
    private void notifyUpdateListeners() {
        Object[] listenerArray = updateListenerList.getListeners();
        for (int i = 0; i < listenerArray.length; ++i) {
            ISWTCustomUpdate l = (ISWTCustomUpdate) listenerArray[i];
            if (l != null) {
                l.performUpdate();
            }
        }
