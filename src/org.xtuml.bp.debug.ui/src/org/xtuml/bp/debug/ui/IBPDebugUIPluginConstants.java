...
public interface IBPDebugUIPluginConstants {
    ...
    public static final String PLUGIN_ID = "org.xtuml.bp.debug.ui"; //$NON-NLS-1$

    /* BP debug perspective id*/
    public static final String BPPERSPECTIVE_ID = "org.xtuml.bp.debug.ui.DebugPerspective";
	...
	public static final String ID_VIEW_EXPLORER = "org.xtuml.bp.ui.explorer.ExplorerView";//$NON-NLS-1$
	public static final String ID_VIEW_INSTANCE = "org.xtuml.bp.ui.session.views.SessionExplorerView";//$NON-NLS-1$
	public static final String ID_VIEW_MONITOR = "org.xtuml.bp.ui.explorer.MonitorExplorerView";//$NON-NLS-1$
