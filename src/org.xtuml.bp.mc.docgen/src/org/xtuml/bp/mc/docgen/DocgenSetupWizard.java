...
public class DocgenSetupWizard extends Wizard implements IWorkbenchWizard, IDelegateWizard {

    private Object extraData;

    public DocgenSetupWizard() {
        super();
    ...
    public boolean performFinish() {
        if (extraData instanceof IProject) {
            DocgenNature nature = DocgenNature.getDefault();
