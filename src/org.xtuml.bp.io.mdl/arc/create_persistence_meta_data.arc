      ...
      .else
        ...
        .for each e in inner_path
          ...
          .if(innerCount == expected)
            ...
            .select any rel from instances of R_REL where (selected.Numb == relNumb)
            ...
            .if ( is_refl.result )
              ...
              .if ( aone.Txt_Phrs == e.rel_phrase )
                .assign nextRelPhrase = "${aoth.Txt_Phrs}"
              .else
                .assign nextRelPhrase = "${aone.Txt_Phrs}"
              .end if
            .end if
          .end if
        .end for
