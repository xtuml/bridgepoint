package com.mentor.nucleus.bp.ui.session.actions;
//=====================================================================
//
// File:      $RCSfile$
// Version:   $Revision$
...
import com.mentor.nucleus.bp.ui.session.views.*;
import com.mentor.nucleus.bp.ui.session.*;
/**
...
public class FilterSelectionAction extends Action {
  ...
  private static final String FILTER_TITLE_MESSAGE = "SessionExplorer Filters";

  private SessionExplorerView explorer = null;
  /**
   * Creates the action.
   * 
   ...
   */
  public FilterSelectionAction(SessionExplorerView explorer, String label) {
    super(label);
    this.explorer = explorer;
    setToolTipText(FILTER_TOOL_TIP);
    PlatformUI.getWorkbench().getHelpSystem().setHelp(this, ISessionExplorerHelpContextIds.FILTER_SELECTION_ACTION);
    setEnabled(true);
  }
  /*
