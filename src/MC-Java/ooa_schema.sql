...
CREATE ROP REF_ID R110 FROM M O_RTIDA (Oid_ID, OIR_ID, Obj_ID, Rel_ID) TO 1 R_RTO (Oid_ID, OIR_ID, Obj_ID, Rel_ID);
...
CREATE ROP REF_ID R612 FROM MC ACT_BLK (Parsed_Action_ID) TO 1 ACT_ACT (Action_ID);
