...
/**
 * This class holds MC property values. Right now everything in this class is
 * static and it is not overridden on a per-MC basis. However, it could be. To
 * make it clear that it could be this class is being marked abstract. This is
 * to make it clear that in the future if we decide to make this configurable on
 * a per-MC basis (instance-based instead of static methods), then it should be
 * extended with a specific class in the MC (and in the bp.mc.template).
 *
 */
public abstract class AbstractProperties {
    ...
    private static String names[] = { MARKING_FILE_LOCATION_NAME, GENERATED_SOURCE_CODE_DEST_NAME, BUILD_COMMAND_NAME,
            ADDITIONAL_ARGS_FOR_BUILDER_NAME, GENERATED_CODE_DEST_NAME, LAUNCH_SPEC_LOCATION_NAME,
            XBUILD_LOCAL_LOCATION_NAME };

    private static String defaults[] = { MARKING_FILE_LOCATION_DEFAULT, GENERATED_SOURCE_CODE_DEST_DEFAULT,
            BUILD_COMMAND_DEFAULT, ADDITIONAL_ARGS_FOR_BUILDER_DEFAULT, GENERATED_CODE_DEST_DEFAULT,
