...
INSERT INTO T_TPS VALUES (12,  27, '->C_C[R2955]->PE_PE[R8003]->EP_PKG[R8001]->EP_PKGREF[R1402.''RefersTo'']->EP_PKG[R1402.''RefersTo'']', '', 'Isexecutingorownsexecutableelements() == true', true);
INSERT INTO T_TPS VALUES (12,  27, '->C_C[R2955]->PE_PE[R8003]->EP_PKG[R8001]', '', 'Isexecutingorownsexecutableelements() == true');
INSERT INTO T_TPS VALUES (12,  27, '->CL_IC[R2963]->C_C[R4201]->PE_PE[R8003]->EP_PKG[R8001]->EP_PKGREF[R1402.''RefersTo'']->EP_PKG[R1402.''RefersTo'']', '', 'Isexecutingorownsexecutableelements() == true', true);
...
INSERT INTO T_TPS VALUES (16,  20, '->SPR_PEP[R4503]->C_EP[R4501]->C_PP[R4006]');
