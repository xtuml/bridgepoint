...
public class AllActivityModifier implements IAllActivityModifier
{
	...
	public static int accessSuc_Pars( boolean writeValue, int newValue, Object o_input )
    {
        ...
        if (!writeValue) {
          ...
          TextPlugin.logError("AllActivityModifier.accessSucPar:Unrecognized Action Home", ia);
        }
        return Parsestatus_c.OOA_UNINITIALIZED_ENUM;
    }
    private void clearActionPlaceholder(Object o_input)
    {
