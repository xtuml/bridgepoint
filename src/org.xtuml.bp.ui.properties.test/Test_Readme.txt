...
- On the Test tab, under 'Run a single test', specify 
  project 'org.xtuml.bp.ui.properties.test' and test class 
  'PropertiesTestSuite'
- Change workspace data to '${eclipse_home}/bp_tests/properties'
- Change VM Arguments to 
  '-DWORKSPACE_PATH=${workspace_loc}/org.xtuml.bp.ui.properties.test/ -DLOGFILE_PATH=${eclipse_home}/bp_tests/properties/.metadata/.log'
