...
{
  MicrowaveOven_MO_TRN * turntable;MicrowaveOven_MO_D * door;MicrowaveOven_MO_B * beeper;MicrowaveOven_MO_IL * light;MicrowaveOven_MO_MT * tube;MicrowaveOven_MO_O * mo;
