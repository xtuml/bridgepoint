...
{
  r_t distance;Tracking_TrackPoint * trackPoint;Tracking_TrackPoint * lastPoint=0;Tracking_TrackPoint * firstPoint=0;Tracking_WorkoutTimer * workoutTimer=0;
...
/*
 * RELATE WorkoutTimer TO TrackLog ACROSS R4
 */
void
Tracking_TrackLog_R4_Link_provides_high_resolution_data_for( Tracking_WorkoutTimer * part, Tracking_TrackLog * form )
{
  if ( (part == 0) || (form == 0) ) {
    XTUML_EMPTY_HANDLE_TRACE( "TrackLog", "Tracking_TrackLog_R4_Link_provides_high_resolution_data_for" );
    return;
  }
  form->WorkoutTimer_R4_is_being_timed_by = part;
  part->TrackLog_R4_provides_high_resolution_data_for = form;
}

/*
 * UNRELATE WorkoutTimer FROM TrackLog ACROSS R4
 */
void
Tracking_TrackLog_R4_Unlink_provides_high_resolution_data_for( Tracking_WorkoutTimer * part, Tracking_TrackLog * form )
{
  if ( (part == 0) || (form == 0) ) {
    XTUML_EMPTY_HANDLE_TRACE( "TrackLog", "Tracking_TrackLog_R4_Unlink_provides_high_resolution_data_for" );
    return;
  }
  form->WorkoutTimer_R4_is_being_timed_by = 0;
  part->TrackLog_R4_provides_high_resolution_data_for = 0;
}
