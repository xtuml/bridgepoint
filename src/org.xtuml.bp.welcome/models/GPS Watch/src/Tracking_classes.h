...
#define Tracking_TrackLog_CLASS_NUMBER 3
#define Tracking_TrackPoint_CLASS_NUMBER 4
#define Tracking_LapMarker_CLASS_NUMBER 5
#define Tracking_HeartRateSample_CLASS_NUMBER 6
