...
public class ModelContentOutlinePage extends ContentOutlinePage {
   ...
   * Menu id "org.xtuml.bp.ui.canvas.outline"
   */
  ...
  protected void createMenus() {
    ...
    MenuManager createMenuManager = new MenuManager("New", "org.xtuml.bp.ui.newroot"); //$NON-NLS-2$
    ...
    menuMgr.add(new Separator("org.xtuml.bp.ui.context-internal")); //$NON-NLS-1$
    menuMgr.add(new Separator("org.xtuml.bp.ui.context-internal-end")); //$NON-NLS-1$
    ...
    getSite().registerContextMenu("org.xtuml.bp.ui.canvas.outline", menuMgr, viewer); //$NON-NLS-1$
  }
  ...
  private void handleOpen() {
    ...
    //
    IExtensionPoint extPt = reg.getExtensionPoint("org.xtuml.bp.core.editors");
