package com.mentor.nucleus.qa.odometer.views;
...
public class OdoView extends ViewPart {
	 ...
	 */
	public static final String ID = "com.mentor.nucleus.qa.odometer.views.OdoView";
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "com.mentor.nucleus.qa.odometer.viewer");
		makeActions();
		hookContextMenu();
	...
	public void setActionToEnableCapture() {
	  ...
	  private String getHostName() {
		...
		final static String ABOUT_MAPPINGS = "../com.mentor.nucleus.bp.pkg/about.mappings";
