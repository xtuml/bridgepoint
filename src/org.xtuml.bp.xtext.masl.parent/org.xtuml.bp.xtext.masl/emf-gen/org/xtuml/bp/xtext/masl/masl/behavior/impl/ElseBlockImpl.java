 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtuml.bp.xtext.masl.masl.behavior.impl.ElseBlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElseBlockImpl extends MinimalEObjectImpl.Container implements ElseBlock {
	...
	public EList<AbstractStatement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<AbstractStatement>(AbstractStatement.class, this, BehaviorPackage.ELSE_BLOCK__STATEMENTS);
		}
		return statements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviorPackage.ELSE_BLOCK__STATEMENTS:
