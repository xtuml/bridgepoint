 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtuml.bp.xtext.masl.masl.structure.impl.DomainFunctionDefinitionImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link org.xtuml.bp.xtext.masl.masl.structure.impl.DomainFunctionDefinitionImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.xtuml.bp.xtext.masl.masl.structure.impl.DomainFunctionDefinitionImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link org.xtuml.bp.xtext.masl.masl.structure.impl.DomainFunctionDefinitionImpl#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link org.xtuml.bp.xtext.masl.masl.structure.impl.DomainFunctionDefinitionImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainFunctionDefinitionImpl extends AbstractTopLevelElementImpl implements DomainFunctionDefinition {
	/**
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, StructurePackage.DOMAIN_FUNCTION_DEFINITION__PARAMETERS);
		}
		return parameters;
	}
	...
	public void setVisibility(Visibility newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.DOMAIN_FUNCTION_DEFINITION__VISIBILITY, oldVisibility, visibility));
	}
	...
	public DomainDefinition getDomain() {
		if (domain != null && domain.eIsProxy()) {
			...
			if (domain != oldDomain) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StructurePackage.DOMAIN_FUNCTION_DEFINITION__DOMAIN, oldDomain, domain));
			}
		}
		return domain;
	}
	...
	public void setDomain(DomainDefinition newDomain) {
		...
		domain = newDomain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.DOMAIN_FUNCTION_DEFINITION__DOMAIN, oldDomain, domain));
	}
	...
	public NotificationChain basicSetBody(CodeBlock newBody, NotificationChain msgs) {
		...
		body = newBody;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StructurePackage.DOMAIN_FUNCTION_DEFINITION__BODY, oldBody, newBody);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBody(CodeBlock newBody) {
		if (newBody != body) {
			NotificationChain msgs = null;
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StructurePackage.DOMAIN_FUNCTION_DEFINITION__BODY, null, msgs);
			if (newBody != null)
				msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StructurePackage.DOMAIN_FUNCTION_DEFINITION__BODY, null, msgs);
			msgs = basicSetBody(newBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.DOMAIN_FUNCTION_DEFINITION__BODY, newBody, newBody));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.DOMAIN_FUNCTION_DEFINITION__PARAMETERS:
				return ((InternalEList<?>)getParameters()).basicRemove(otherEnd, msgs);
			case StructurePackage.DOMAIN_FUNCTION_DEFINITION__RETURN_TYPE:
				return basicSetReturnType(null, msgs);
			case StructurePackage.DOMAIN_FUNCTION_DEFINITION__BODY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StructurePackage.DOMAIN_FUNCTION_DEFINITION__VISIBILITY:
				return getVisibility();
			case StructurePackage.DOMAIN_FUNCTION_DEFINITION__DOMAIN:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Parameterized.class) {
			switch (derivedFeatureID) {
				case StructurePackage.DOMAIN_FUNCTION_DEFINITION__PARAMETERS: return StructurePackage.PARAMETERIZED__PARAMETERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Parameterized.class) {
			switch (baseFeatureID) {
				case StructurePackage.PARAMETERIZED__PARAMETERS: return StructurePackage.DOMAIN_FUNCTION_DEFINITION__PARAMETERS;
				default: return -1;
			}
		}
