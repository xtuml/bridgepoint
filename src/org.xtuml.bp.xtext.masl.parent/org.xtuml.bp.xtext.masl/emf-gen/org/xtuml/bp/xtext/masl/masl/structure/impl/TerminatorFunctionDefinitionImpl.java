...
public class TerminatorFunctionDefinitionImpl extends AbstractTopLevelElementImpl implements TerminatorFunctionDefinition {
	...
	public NotificationChain basicSetReturnType(AbstractTypeReference newReturnType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StructurePackage.TERMINATOR_FUNCTION_DEFINITION__RETURN_TYPE, oldReturnType, newReturnType);
	...
	public void setReturnType(AbstractTypeReference newReturnType) {
		if (newReturnType != returnType) {
			...
			if (returnType != null)
				msgs = ((InternalEObject)returnType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StructurePackage.TERMINATOR_FUNCTION_DEFINITION__RETURN_TYPE, null, msgs);
			if (newReturnType != null)
				msgs = ((InternalEObject)newReturnType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StructurePackage.TERMINATOR_FUNCTION_DEFINITION__RETURN_TYPE, null, msgs);
			msgs = basicSetReturnType(newReturnType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.TERMINATOR_FUNCTION_DEFINITION__RETURN_TYPE, newReturnType, newReturnType));
	}
