 ...
 * @generated
 */
public class TerminatorServiceDeclarationImpl extends AbstractFeatureImpl implements TerminatorServiceDeclaration {
	/**
	...
	public EList<Pragma> getPragmas() {
		if (pragmas == null) {
			pragmas = new EObjectContainmentEList<Pragma>(Pragma.class, this, StructurePackage.TERMINATOR_SERVICE_DECLARATION__PRAGMAS);
		}
		return pragmas;
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, StructurePackage.TERMINATOR_SERVICE_DECLARATION__PARAMETERS);
		}
		return parameters;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.TERMINATOR_SERVICE_DECLARATION__PRAGMAS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Pragmatized.class) {
			switch (derivedFeatureID) {
				case StructurePackage.TERMINATOR_SERVICE_DECLARATION__PRAGMAS: return StructurePackage.PRAGMATIZED__PRAGMAS;
				default: return -1;
			}
		}
		if (baseClass == Parameterized.class) {
			switch (derivedFeatureID) {
				case StructurePackage.TERMINATOR_SERVICE_DECLARATION__PARAMETERS: return StructurePackage.PARAMETERIZED__PARAMETERS;
				default: return -1;
			}
		}
		if (baseClass == Visualized.class) {
			switch (derivedFeatureID) {
				case StructurePackage.TERMINATOR_SERVICE_DECLARATION__VISIBILITY: return StructurePackage.VISUALIZED__VISIBILITY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Pragmatized.class) {
			switch (baseFeatureID) {
				case StructurePackage.PRAGMATIZED__PRAGMAS: return StructurePackage.TERMINATOR_SERVICE_DECLARATION__PRAGMAS;
				default: return -1;
			}
		}
		if (baseClass == Parameterized.class) {
			switch (baseFeatureID) {
				case StructurePackage.PARAMETERIZED__PARAMETERS: return StructurePackage.TERMINATOR_SERVICE_DECLARATION__PARAMETERS;
				default: return -1;
			}
		}
		if (baseClass == Visualized.class) {
			switch (baseFeatureID) {
				case StructurePackage.VISUALIZED__VISIBILITY: return StructurePackage.TERMINATOR_SERVICE_DECLARATION__VISIBILITY;
				default: return -1;
			}
		}
		if (baseClass == AbstractActionDeclaration.class) {
