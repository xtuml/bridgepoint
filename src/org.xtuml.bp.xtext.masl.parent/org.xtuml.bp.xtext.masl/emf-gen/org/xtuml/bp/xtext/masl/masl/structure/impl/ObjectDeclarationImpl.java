 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtuml.bp.xtext.masl.masl.structure.impl.ObjectDeclarationImpl#getPragmas <em>Pragmas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectDeclarationImpl extends AbstractNamedImpl implements ObjectDeclaration {
	/**
	...
	protected EClass eStaticClass() {
		return StructurePackage.Literals.OBJECT_DECLARATION;
	}
	...
	public EList<Pragma> getPragmas() {
		if (pragmas == null) {
			pragmas = new EObjectContainmentEList<Pragma>(Pragma.class, this, StructurePackage.OBJECT_DECLARATION__PRAGMAS);
		}
		return pragmas;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.OBJECT_DECLARATION__PRAGMAS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Pragmatized.class) {
			switch (derivedFeatureID) {
				case StructurePackage.OBJECT_DECLARATION__PRAGMAS: return StructurePackage.PRAGMATIZED__PRAGMAS;
				default: return -1;
			}
		}
		if (baseClass == ObjectOrRole.class) {
			switch (derivedFeatureID) {
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Pragmatized.class) {
			switch (baseFeatureID) {
				case StructurePackage.PRAGMATIZED__PRAGMAS: return StructurePackage.OBJECT_DECLARATION__PRAGMAS;
				default: return -1;
			}
		}
		if (baseClass == ObjectOrRole.class) {
