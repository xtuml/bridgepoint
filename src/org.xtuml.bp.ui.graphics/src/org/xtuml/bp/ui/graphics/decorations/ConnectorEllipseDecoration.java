//========================================================================
//
//File:      $RCSfile: ConnectorEllipseDecoration.java,v $
...
//======================================================================== 
//
package org.xtuml.bp.ui.graphics.decorations;
...
public class ConnectorEllipseDecoration extends PolygonDecoration {
	...
	public ConnectorEllipseDecoration(String tooltip, ConnectorEditPart parent) {
		setRadius(8);
		setScale(1, 1);
		if(!tooltip.equals("")) {
	...
	protected void fillShape(Graphics g) {
		...
		computeArcBounds(TEMP_RECTANGLE);
		g.fillArc(TEMP_RECTANGLE, -myAngle + 90, 360);
	}
	...
	protected void outlineShape(Graphics g) {
		...
		g.setLineWidth(getLineWidth());
		computeArcBounds(TEMP_RECTANGLE);
		g.drawArc(TEMP_RECTANGLE, -myAngle + 90, 360);
	}
