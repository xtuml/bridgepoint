...
//======================================================================== 
//
package org.xtuml.bp.ui.graphics.outline;
...
import org.xtuml.bp.ui.canvas.ModelOutlineSorter;
...
public class GraphicalOutlinePage extends ContentOutlinePage {
	...
	protected void createMenus() {
		...
		final MenuManager createMenuManager = new MenuManager(
				"Ne&w", "org.xtuml.bp.ui.newroot"); //$NON-NLS-2$
		final MenuManager openMenuManager = new MenuManager(
				"Open Wit&h", "org.xtuml.bp.ui.openroot"); //$NON-NLS-2$
		...
		menuManager.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager mgr) {
				...
				openMenuManager.add(new GroupMarker(
						"org.xtuml.bp.ui.openmenu")); //$NON-NLS-1$
				mgr.add(new Separator(
						"org.xtuml.bp.ui.context-internal")); //$NON-NLS-1$
				mgr.add(new Separator(
		...
		getSite().registerContextMenu(
				"org.xtuml.bp.ui.graphics.outline.menu", menuManager,
	...
	private void handleOpen() {
		...
		IExtensionPoint extPt = reg
				.getExtensionPoint("org.xtuml.bp.core.editors");
