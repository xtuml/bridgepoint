...
import org.xtuml.bp.mc.wasl.WaslExportBuilder;
import org.xtuml.bp.ui.explorer.ModelLabelProvider;

public class WaslExporterPreferencePage extends PropertyPage {

    private WaslExporterPreferences prefs;
    ...
    protected Control createContents(Composite parent) {
        prefs = new WaslExporterPreferences(getProject());
        ...
        enableFormatButton.setText("Format output WASL");
    ...
    private List<NonRootModelElement> getBuildElements() {
        return WaslExportBuilder.getPossibleBuildElements(getProject());
    }
    ...
    private void setDefaultCheckedElements() {
        for (NonRootModelElement element : getBuildElements()) {
            if (WaslExportBuilder.getDefaultBuildElements(getProject()).stream().anyMatch((nrme) -> {
