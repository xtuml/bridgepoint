package org.xtuml.bp.sequencecapture.views;
...
import org.xtuml.bp.sequencecapture.SequenceBuilder;
...
public class SequenceCapture extends ViewPart {
	 ...
	 */
	public static final String ID = "org.xtuml.bp.sequencecapture.views.SequenceCapture";
  ...
  private static SequenceCapture instance = null;
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "org.xtuml.bp.sequencecapture.viewer");
		makeActions();
		hookContextMenu();
