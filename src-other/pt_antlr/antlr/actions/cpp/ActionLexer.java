// $ANTLR 2.7.2: "action.g" -> "ActionLexer.java"$
 ...
 */
	...
	protected final void mID(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop86:
		do {
			if ((_tokenSet_9.member(LA(1))) && (true)) {
				{
				switch ( LA(1)) {
				case 'a':  case 'b':  case 'c':  case 'd':
				case 'e':  case 'f':  case 'g':  case 'h':
	...
	protected final void mTEXT_ARG(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_10.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff'))) {
				...
				{
				if ((_tokenSet_4.member(LA(1))) && (_tokenSet_11.member(LA(2)))) {
					mWS(false);
				}
 ...
 */
	protected final boolean  mID_ELEMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		case '(':  case '<':
		{
			...
			else if ((_tokenSet_15.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff'))) {
			}
			else {
				throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());
			}
		...
		default:
			if ((LA(1)=='-') && (LA(2)=='>')) {
				...
				{
				if (((_tokenSet_17.member(LA(1))) && (_tokenSet_16.member(LA(2))))&&(transInfo!=null && transInfo.refRuleRoot!=null)) {
					{
					switch ( LA(1)) {
					case '\t':  case '\n':  case '\r':  case ' ':
					{
 ...
 */
	protected final void mAST_CTOR_ELEMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		else if ((_tokenSet_19.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff'))) {
			mTREE_ELEMENT(false);
		}
	...
	protected final void mARG(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		default:
			if ((_tokenSet_19.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff'))) {
				mTREE_ELEMENT(false);
			}
	...
	protected final void mTEXT_ARG_ID_ELEMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		case '(':
		{
			match('(');
			{
			if ((_tokenSet_4.member(LA(1))) && (_tokenSet_23.member(LA(2)))) {
				_saveIndex=text.length();
				mWS(false);
				text.setLength(_saveIndex);
			}
			else if ((_tokenSet_23.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff'))) {
			}
			else {
				throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());
			}
			...
			_loop69:
			do {
				if ((_tokenSet_24.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff'))) {
					mTEXT_ARG(false);
					{
					_loop68:
					do {
		...
		case '[':
		{
			...
			do {
				if ((LA(1)=='[')) {
					...
					else if ((_tokenSet_24.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff'))) {
					}
					else {
						throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());
					}
	...
	protected final void mINT_OR_FLOAT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop114:
		do {
			if (((LA(1) >= '0' && LA(1) <= '9')) && (_tokenSet_25.member(LA(2)))) {
				mDIGIT(false);
			}
			else {
		...
		if ((LA(1)=='L') && (_tokenSet_26.member(LA(2)))) {
			...
			_loop117:
			do {
				if (((LA(1) >= '0' && LA(1) <= '9')) && (_tokenSet_26.member(LA(2)))) {
					mDIGIT(false);
				}
				else {
					break _loop117;
		...
		else if ((_tokenSet_26.member(LA(1))) && (true)) {
		}
		else {
			throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());
		}
