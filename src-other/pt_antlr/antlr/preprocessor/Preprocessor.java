// $ANTLR 2.7.2: "preproc.g" -> "Preprocessor.java"$
...
public Preprocessor(ParserSharedInputState state) {
  ...
  tokenNames = _tokenNames;
	...
	private static final long[] mk_tokenSet_1() {
		long[] data = { 2329026L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_1 = new BitSet(mk_tokenSet_1());
	private static final long[] mk_tokenSet_2() {
		long[] data = { 229632L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_4() {
		long[] data = { 229826L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_4 = new BitSet(mk_tokenSet_4());
	private static final long[] mk_tokenSet_5() {
		long[] data = { 2101312L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_5 = new BitSet(mk_tokenSet_5());
	private static final long[] mk_tokenSet_6() {
		long[] data = { 17007042L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_6 = new BitSet(mk_tokenSet_6());
	private static final long[] mk_tokenSet_7() {
		long[] data = { 50561474L, 0L};
		return data;
	}
