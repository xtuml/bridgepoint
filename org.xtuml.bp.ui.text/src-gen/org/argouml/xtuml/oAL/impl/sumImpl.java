 ...
 * <ul>
 *   <li>{@link org.argouml.xtuml.oAL.impl.sumImpl#getLt <em>Lt</em>}</li>
 *   <li>{@link org.argouml.xtuml.oAL.impl.sumImpl#getRt <em>Rt</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class sumImpl extends MinimalEObjectImpl.Container implements sum
{
  ...
  {
    return OALPackage.Literals.SUM;
  }
  ...
  public NotificationChain basicSetLt(product newLt, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OALPackage.SUM__LT, oldLt, newLt);
  ...
  public void setLt(product newLt)
  {
    if (newLt != lt)
    {
      ...
      if (lt != null)
        msgs = ((InternalEObject)lt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OALPackage.SUM__LT, null, msgs);
      if (newLt != null)
        msgs = ((InternalEObject)newLt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OALPackage.SUM__LT, null, msgs);
      msgs = basicSetLt(newLt, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OALPackage.SUM__LT, newLt, newLt));
  }
  ...
  public EList<product> getRt()
  {
    if (rt == null)
    {
      rt = new EObjectContainmentEList<product>(product.class, this, OALPackage.SUM__RT);
    }
    return rt;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OALPackage.SUM__LT:
        return basicSetLt(null, msgs);
      case OALPackage.SUM__RT:
