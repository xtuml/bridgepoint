 ...
 * <ul>
 *   <li>{@link org.argouml.xtuml.oAL.impl.TypeStatementForImpl#getList <em>List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeStatementForImpl extends TypeStatementImpl implements TypeStatementFor
{
  ...
  {
    return OALPackage.Literals.TYPE_STATEMENT_FOR;
  }
  ...
  public void setList(String newList)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OALPackage.TYPE_STATEMENT_FOR__LIST, oldList, list));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OALPackage.TYPE_STATEMENT_FOR__LIST:
        return getList();
    }
